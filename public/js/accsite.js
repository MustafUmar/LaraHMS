...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Bill.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Bill.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getBill: function getBill() {
      ...
      axios.get('api/payment/bill/' + this.pay).then(function (response) {
        _this.loading = false;
        console.log(response.data);
        _this.payment = response.data;
      })["catch"](function (err) {
        _this.error.stat = true;
        _this.loading = false;
        console.log(err);
      });
    },
    chargeBill: function chargeBill() {
      ...
      if (!this.$v.$invalid) {
        if (!!this.pay) {
          ...
          this.errors = {};
          axios.post('api/payment/bill/charge', {
            pid: this.pay,
            amount: this.amount,
            type: this.type
    ...
    getError: function getError(field) {
      if (_.has(this.errors, field)) return this.errors[field][0];else return null;
    },
    getSingleError: function getSingleError() {
    ...
    totalPerPresc: function totalPerPresc(i) {
      return this.payment.patpresc[i].meds.reduce(this.prescPriceUnit(), 0);
    },
    prescBalance: function prescBalance(i) {
      this.payment.patpresc[i].meds.reduce(function (ac, val) {
        return ac + parseFloat(+val.amount);
      }, 0);
    },
    prescPriceUnit: function prescPriceUnit(ac, val) {
      switch (meds.unit) {
        case 'sat':
    ...
    medPrice: function medPrice(i, y) {
      var med = this.payment.patpresc[i].meds[y];
  ...
  computed: {
    totalMeds: function totalMeds() {
      if (this.payment.patpresc && this.payment.patpresc.length > 0) {
        var total = 0;
        this.payment.patpresc.forEach(function (v) {
          total += v.meds.reduce(function (ac, val) {
            switch (meds.unit) {
              case 'sat':
                return ac + parseInt(val.qty) * parseFloat(+val.pharm.price_per_sat);
                break;
    ...
    medsBalance: function medsBalance() {
      if (this.payment.patpresc && this.payment.patpresc.length > 0) {
        var total = 0;
        this.payment.patpresc.forEach(function (v) {
          total += v.meds.reduce(function (ac, val) {
    ...
    totalService: function totalService() {
      if (this.payment.patservice && this.payment.patservice.length > 0) {
        ...
        }, 0).toFixed(2); // return _.reduce(this.payment.patservice, function(ac, val) {
        //     return ac + (val.services.charge)
        // }, 0)
      } else return null;
    },
    serviceBalance: function serviceBalance() {
      if (this.payment.patservice && this.payment.patservice.length > 0) {
        return this.payment.patservice.reduce(function (ac, val) {
    ...
    totalBalance: function totalBalance() {
      return parseFloat(+this.payment.paid) < parseFloat(this.grandTotal) ? Math.abs(parseFloat(this.grandTotal) - parseFloat(this.payment.paid)) : 0; // return parseFloat(this.amountPaid) < parseFloat(this.grandTotal) ? Math.abs(parseFloat(this.grandTotal) - parseFloat(this.amountPaid)) : 0
    },
    serviceStat: function serviceStat() {
      var status = 'Pending';
      var compcount = 0;

      if (this.payment.patservice) {
        for (var i = 0; i < this.payment.patservice.length; i++) {
    ...
    prescStat: function prescStat() {
      var status = 'Pending';
      var compcount = 0;

      if (this.payment.patpresc) {
        for (var i = 0; i < this.payment.patpresc.length; i++) {
  ...
  validations: {
    amount: {
      ...
      minValue: Object(vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_0__["minValue"])(5),
      maxValue: Object(vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_0__["maxValue"])(10000000)
    },
    type: {
      required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_0__["required"]
    }
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patient.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Patient.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPatient: function getPatient() {
      ...
      axios.get('api/payment/patient/' + this.pat).then(function (response) {
        _this.loading = false;
        console.log(response.data);
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patients.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Patients.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getRecent: function getRecent() {
      ...
      axios.get('api/payment/patients').then(function (response) {
        _this.loading = false;
        console.log(response.data);
    ...
    search: function search() {
      ...
      if (!!this.term && this.term.length > 1 && this.term.length < 15) {
        this.loading = true;
        axios.get('api/payment/patient/search', {
          params: {
            'search': this.term
          }
        }).then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/PaymentSummary.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/PaymentSummary.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getRecent: function getRecent() {
      ...
      axios.get('api/payment/recent').then(function (response) {
        _this.loading = false;
        console.log(response.data);
        _this.payments = response.data.paystat;
        _this.recents = response.data.recent;
      })["catch"](function (err) {
        _this.loading = false;
        console.log(err);
      });
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Payments.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Payments.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    this.getPayment(); // this.$refs.filterDatePicker.$vnode.child.weekdays = ["M", "T", "W", "T", "F", "S", "S"];
  },
  data: function data() {
    return {
      payments: [],
  ...
  methods: {
    getPayment: function getPayment() {
      ...
      this.loading = true;
      axios.post('api/payments', this.filters).then(function (response) {
        // console.log(response.data)
    ...
    applyFilter: function applyFilter(v, e) {
      switch (v) {
        case 'on':
  ...
  components: {
    'datetimepicker': vue_datetime__WEBPACK_IMPORTED_MODULE_0__["Datetime"]
  }
});
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614& ***!
  \***************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("page-heading", { attrs: { heading: "Bill" } }),
      _vm._v(" "),
      _c("div", [
            ...
            !_vm.error.stat
              ? _c("div", [
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "thin-light-border two-flexed-spacebtw mb-2 p-1"
                    },
                    [
                      _c("div", [
                        _c(
                        ...
                        _vm._v(" "),
                        _vm.serviceStat == "Complete" &&
                        _vm.prescStat == "Complete"
                        ...
                        [
                          _c("div", [
                            ...
                            _c("span", { staticClass: "text-danger" }, [
                              _vm._v(" " + _vm._s(_vm.getSingleError()))
                            ])
                          ])
                        ]
                      )
                            ...
                            _c("div", { staticClass: "col-md-8" }, [
                              _c("div", { staticClass: "card mb-1" }, [
                                _c("div", { staticClass: "card-body" }, [
                                  _c(
                                    "div",
                                    { staticClass: "two-flexed-spacebtw" },
                                    [
                                      _c("div", [
                                        _c("span", { staticClass: "dim-txt" }, [
                                          _vm._v(
                                            _vm._s(_vm.payment.patient.patno)
                                          )
                                        ]),
                                        _vm._v(" "),
                                        _c(
                                          "div",
                                          { staticClass: "fs-bolder" },
                                          [
                                            _vm._v(
                                              _vm._s(
                                                _vm.payment.patient.fullname
                                              )
                                            )
                                          ]
                                        )
                                          ...
                                          _c("div", { staticClass: "py-2" }, [
                                            ...
                                            _vm.prescStat == "Complete"
                                              ? _c("span", [
                                                  ...
                                                  _c("i", {
                                                    staticClass:
                                                      "fas fa-check-circle ml-3"
                                                  })
                                                ])
                                              : _vm.serviceStat ==
                                                  "Incomplete" ||
                                                _vm.prescStat == "Incomplete"
                                              ? _c("span", [
                                                  _vm._v(
                                                    "\n                                                            Incomplete "
                                                  ),
                              ...
                              _c("div", { staticClass: "card mb-1" }, [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "card-header two-flexed-spacebtw"
                                  },
                                  [
                                    _c("h6", [_vm._v("Services")]),
                                    _vm._v(" "),
                                    _c("div", { staticClass: "fs-3 dim-txt" }, [
                                      _vm.serviceStat == "Complete"
                                        ? _c(
                                            "span",
                                            {
                                        ...
                                        _c(
                                          ...
                                          [
                                            ...
                                            _c("tr", [
                                              _c("th", [_vm._v("Total")]),
                                              _c("th", [
                                                _vm._v(_vm._s(_vm.totalService))
                                              ]),
                                              _vm._v(" "),
                                              _c("th", [
                                                _vm._v(
                              ...
                              _c("div", { staticClass: "card mb-1" }, [
                                ...
                                _c("div", { staticClass: "card-body" }, [
                                  _vm.totalMeds
                                    ? _c(
                                        "div",
                                        _vm._l(_vm.payment.patpresc, function(
                                          presc,
                                          index
                                        ) {
                                          return _c(
                                            ...
                                            {
                                              key: presc.id,
                                              staticClass: "table table-sm mb-1"
                                            },
                                            [
                                              _vm._m(2, true),
                                              _vm._v(" "),
                              ...
                              _c("div", { staticClass: "card" }, [
                                ...
                                _c("div", { staticClass: "card-body" }, [
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "table table-striped table-sm fs-5"
                                    },
                                    [
                                      _c("tr", [
                                        _c("td", [_vm._v("Medicines:")]),
                                        _c("td", [
                                          _vm._v(
                                            _vm._s(
                                              _vm.totalMeds
                                      ...
                                      _vm._v(" "),
                                      _c("tr", [
                                        _c("td", [_vm._v("7.5% VAT:")]),
                                        _c("td", [
                                          _vm._v(_vm._s(0.075 * _vm.subTotal))
                                        ])
                                      ]),
                                      _vm._v(" "),
                                      _c("tr", [
                                      ...
                                      _c("tr", [
                                        ...
                                        _c("td", [
                                          _vm._v(
                                            _vm._s(
                                              parseFloat(_vm.serviceBalance) +
                                                parseFloat(_vm.medsBalance)
                                            )
                                          )
                                        ])
                                      ]),
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "modal bill-payment",
                      attrs: {
                        tabindex: "-1",
                        role: "dialog",
                        id: "bill-charge-modal"
                      }
                    },
                    [
                      _c(
                              ...
                              _c("div", { staticClass: "card" }, [
                                _c("div", { staticClass: "card-body" }, [
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "two-flexed-spacebtw alert alert-primary p-1 mb-2"
                                    },
                                    [
              ...
              : _c("div", { staticClass: "row justify-content-center" }, [
                  _c(
                    "div",
                    { staticClass: "col pd-3 bg-lightgray text-center" },
                    [
                      _c("p", { staticClass: "text-muted fs-8" }, [
                        _vm._v("No such record !")
                      ]),
                      _vm._v(" "),
                      _c(
                        "p",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "d-flex justify-content-center align-items-center loader-wrapper"
      },
      [
        _c("div", { staticClass: "loader-content fa-lg" }, [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("tr", [
      _c("td", [_vm._v("4 unit of Medicine name")]),
      _vm._v(" "),
      _c("td"),
      _vm._v(" "),
      _c("td")
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("td", [
      _c("span", { staticClass: "fs-bold" }, [_vm._v("Subtotal:")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("td", [
      _c("span", { staticClass: "fs-bold fs-6 text-primary" }, [
        _vm._v("Total:")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("td", [
      _c("span", { staticClass: "text-info" }, [_vm._v("Amount Paid:")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("td", [
      _c("span", { staticClass: "fs-blod fs-6 text-info" }, [
        _vm._v("Balance:")
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c("h5", { staticClass: "modal-title" }, [_vm._v("Payment")]),
      _vm._v(" "),
      _c(
        "button",
        {
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "alert alert-info p-1" }, [
      _c("small", [
        _vm._v("Only complete payment is accepted for bills below 2000.")
      ])
    ])
  },
  function() {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52& ***!
  \********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pd-3" }, [
      _c("div", { staticClass: "row" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808& ***!
  \******************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("page-heading", { attrs: { heading: "Patient" } }),
      _vm._v(" "),
      _c("div", [
        _c("div", { staticClass: "row justify-content-center" }, [
          _c("div", { staticClass: "col-md-10 col-sm-11" }, [
            _c(
              "div",
              {
                directives: [
            ...
            _c(
              "div",
              { staticClass: "thin-light-border two-flexed-spacebtw mb-2 p-1" },
              [
                _c("div", [
                  _c(
                    "button",
                    { staticClass: "btn btn-light", on: { click: _vm.goBack } },
                    [
                      _c("i", { staticClass: "fas fa-arrow-left" }),
                      _vm._v(" Back")
                    ]
                  ...
                  _c("div", { staticClass: "col-sm-8" }, [
                    _c(
                      ...
                      [
                        _vm._m(3),
                        _vm._v(" "),
                        _vm._l(_vm.patient.payment, function(rec) {
                          return _c("tr", { key: rec.id }, [
                            _c("td", [_vm._v(_vm._s(rec.created_at))]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(_vm._s(rec.patrecord.pat_purpose))
                            ]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(rec.status))]),
                            _vm._v(" "),
                            _c(
                              "td",
                              [
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("table", { staticClass: "table table-sm" }, [
      _c("tr", [_c("td", [_vm._v("Pending Payments")])]),
      _vm._v(" "),
      _c("tr", [_c("td", [_vm._v("Incomplete Payments")])])
    ])
  },
  function() {
    var _vm = this
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b& ***!
  \*******************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("page-heading", { attrs: { heading: "Patients" } }),
      _vm._v(" "),
      _c("div", [
        _c("div", { staticClass: "row justify-content-center" }, [
          _c("div", { staticClass: "col-md-10 col-sm-11" }, [
                ...
                _c("div", { staticClass: "d-flex align-items-center" }, [
                  _c("div", { staticClass: "input-group" }, [
                    _c("input", {
                      ...
                      staticClass: "form-control",
                      attrs: { type: "text", "aria-label": "Patient Search" },
              ...
              _c("div", { staticClass: "card-body" }, [
                _c("div", [
                  _vm.patients.length === 0
                    ? _c("div", [
                        _c("h6", [_vm._v("Recent sessions")]),
                        _vm._v(" "),
                        _vm.recents.length > 0
                          ? _c(
                              "table",
                              { staticClass: "table" },
                              _vm._l(_vm.recents, function(rec) {
                                return _c("tr", { key: rec.id }, [
                                  _vm._m(1, true),
                                  _vm._v(" "),
                                  _c("td", [
                                    _c(
                                      "span",
                                      { staticClass: "dim-txt fs-4" },
                                      [_vm._v("#" + _vm._s(rec.patient.patno))]
                                    )
                                  ]),
                                  _vm._v(" "),
                                  _c("td", { staticClass: "fs-bold wd35" }, [
                                    _vm._v(_vm._s(rec.patient.fullname))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", [_vm._v("time")]),
                                  _vm._v(" "),
                    ...
                    : _c("div", [
                        _c("h6", [_vm._v("Patient search")]),
                        _vm._v(" "),
                        _c(
                          "table",
                          { staticClass: "table table-striped" },
                          _vm._l(_vm.patients, function(pat) {
                            return _c("tr", { key: pat.hashid }, [
                              _vm._m(3, true),
                              _vm._v(" "),
                              _c("td", [
                                _c("span", { staticClass: "dim-txt fs-4" }, [
                                  _vm._v("#" + _vm._s(pat.patno))
                                ])
                              ]),
                              _vm._v(" "),
                              _c("td", { staticClass: "fs-bold wd35" }, [
                                _vm._v(_vm._s(pat.fullname))
                              ]),
                              _vm._v(" "),
                              _c("td", [_vm._v("time")]),
                              _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", [_c("i", { staticClass: "fas fa-caret-right" })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", [
      _c("div", { staticClass: "badge badge-primary" }, [_vm._v("Pending")])
    ])
  },
  function() {
    var _vm = this
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6& ***!
  \*************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("page-heading", { attrs: { heading: "Payments" } }),
      _vm._v(" "),
      _c("div", [
        _c("div", { staticClass: "row justify-content-center" }, [
          _c("div", { staticClass: "col-md-10 col-sm-11" }, [
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col-md-8" }, [
                  ...
                  _c("div", { staticClass: "col" }, [
                    _c("div", { staticClass: "card mb-4" }, [
                      _c("div", { staticClass: "card-body" }, [
                        _c(
                          "div",
                          { staticClass: "two-flexed-right-shrink fs-bold" },
                          [
                            _c("div", { staticClass: "py-2" }, [
                              _vm._v("Pending")
                            ]),
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "px-4 py-2 border-left fs-10 text-secondary"
                              },
                              [
                                _vm.loading
                                  ? _c(
                ...
                _c(
                  ...
                  [
                    _c("router-link", { attrs: { to: "/hpl/payments" } }, [
                      _vm._v("See More...")
                    ])
                  ],
                  1
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba& ***!
  \*******************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "page-layout",
    {
      attrs: { heading: "Payments", menu: true, subloader: _vm.loading },
      scopedSlots: _vm._u([
        {
          key: "left-menu",
          fn: function() {
            ...
            return [
              _c("div", { staticClass: "d-flex align-items-center" }, [
                _c(
                  ...
                  {
                    staticClass:
                      "two-flexed-left-shrink applied-filters-md thin-light-border"
                  },
                  [
                    ...
                    _c("div", { staticClass: "filter-items" }, [
                      _c("span", { staticClass: "badge badge-secondary" }, [
                        _vm._v("Status: " + _vm._s(_vm.filters.stat))
                      ]),
                      _vm._v(" "),
                      _c("span", { staticClass: "badge badge-secondary" }, [
                        _vm._v(
                ...
                _c(
                  "div",
                  { staticClass: "dropdown filter-menu no-propagate" },
                  [
                    _c(
                      "span",
                      {
                        staticClass: "btn btn-light dropdown-toggle",
                        attrs: { id: "filterDrop", "data-toggle": "dropdown" }
                      },
                    ...
                    _c(
                      "div",
                      {
                        ...
                        attrs: { "aria-labelledby": "filterDrop" }
                      },
                      [
                        _c(
                          "div",
                          { staticClass: "dropdown-item-text clearfix" },
                          [
                            _c("span", { on: { click: _vm.resetFilter } }, [
                        ...
                        _c("div", {
                          ...
                          staticClass: "trans-overlay-bottom-up-three-quart"
                        }),
                        _vm._v(" "),
                            ...
                            _c(
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.filters.stat,
                                    expression: "filters.stat"
                                  }
                                ],
                              ...
                              [
                                ...
                                _c(
                                  ...
                                  {
                                    domProps: {
                                      selected: _vm.filters.stat == "Pending"
                                    }
                                  },
                                  [_vm._v("Pending")]
                                ),
                                ...
                                _c(
                                  ...
                                  {
                                    domProps: {
                                      selected: _vm.filters.stat == "Incomplete"
                                    }
                                  },
                                  [_vm._v("Incomplete")]
                                ),
                                ...
                                _c(
                                  ...
                                  {
                                    domProps: {
                                      selected: _vm.filters.stat == "Complete"
                                    }
                                  },
                                  [_vm._v("Complete")]
                                )
                        ...
                        _c("div", { staticClass: "dropdown-item-text" }, [
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.filters.date, "all")
                              },
                              on: {
                                change: [
                                  function($event) {
                                    return _vm.$set(_vm.filters, "date", "all")
                                  },
                                  function($event) {
                                    return _vm.getPayment()
                                  }
                          ...
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.filters.date, "today")
                              },
                              on: {
                                change: [
                                  function($event) {
                          ...
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.filters.date, "yest")
                              },
                              on: {
                                change: [
                                  function($event) {
                                    return _vm.$set(_vm.filters, "date", "yest")
                                  },
                                  function($event) {
                                    return _vm.getPayment()
                                  }
                          ...
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.filters.date, "on")
                              },
                              on: {
                                change: function($event) {
                                  return _vm.$set(_vm.filters, "date", "on")
                                }
                              }
                            }),
                            _vm._v(" "),
                            ...
                            ? _c(
                                ...
                                [
                                  _c("datetimepicker", {
                                    ...
                                    on: {
                                      input: function($event) {
                                        return _vm.applyFilter("on", $event)
                                      }
                                    },
                                    model: {
                                      value: _vm.filters.on_date,
                                      callback: function($$v) {
                                        _vm.$set(_vm.filters, "on_date", $$v)
                                      },
                                      expression: "filters.on_date"
                                    }
                                  })
                                ],
                                1
                          ...
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.filters.date, "from")
                              },
                              on: {
                                change: function($event) {
                                  return _vm.$set(_vm.filters, "date", "from")
                                }
                              }
                            }),
                            _vm._v(" "),
                            ...
                            ? _c(
                                ...
                                [
                                  _c("datetimepicker", {
                                    ...
                                    on: {
                                      input: function($event) {
                                        return _vm.applyFilter("from", $event)
                                      }
                                    },
                                    model: {
                                      value: _vm.filters.from_dt1,
                                      callback: function($$v) {
                                        _vm.$set(_vm.filters, "from_dt1", $$v)
                                      },
                                      expression: "filters.from_dt1"
                                    }
                                  }),
                                  _vm._v(" "),
                                  _c("label", [_vm._v(" to ")]),
                                  ...
                                  _c("datetimepicker", {
                                    ...
                                    model: {
                                      value: _vm.filters.from_dt2,
                                      callback: function($$v) {
                                        _vm.$set(_vm.filters, "from_dt2", $$v)
                                      },
                                      expression: "filters.from_dt2"
                                    }
                                  })
                                ],
                                1
                        ...
                        _c(
                          "div",
                          { staticClass: "dropdown-item-text flexed" },
                          [
                            _c("div", { staticClass: "col" }, [
                              _c("label", { staticClass: "fs-4" }, [
                                _vm._v("Sort by")
                              ]),
                              _vm._v(" "),
                              _c(
          ...
          _vm.payments.length
                  ...
                  [
                    ...
                    _vm._l(_vm.payments, function(pay) {
                      return _c("tr", { key: pay.id }, [
                        _c("td", [
                          _vm._v(
                            _vm._s(pay.firstname) + " " + _vm._s(pay.lastname)
                          )
                        ]),
                        _vm._v(" "),
            ...
            : _c("div", [
                _c(
                  ...
                  [
                    _vm.filters.date == "today"
                      ? _c("span", { staticClass: "fs-7" }, [
                          _vm._v("\n                        No payments made "),
                          _c("strong", [_vm._v("today")]),
                          _vm._v(" with "),
                          _c("strong", [
                            _vm._v(_vm._s(_vm.filters.stat.toLowerCase()))
                          ]),
                          _vm._v(" status.\n                    ")
                        ])
                      : _vm.filters.date == "yest"
                      ? _c("span", { staticClass: "fs-7" }, [
                          _vm._v("\n                        No payments made "),
                          _c("strong", [_vm._v("yesterday")]),
                          _vm._v(" with "),
                          _c("strong", [
                            _vm._v(_vm._s(_vm.filters.stat.toLowerCase()))
                          ]),
                      ...
                      ? _c("span", { staticClass: "fs-7" }, [
                          ...
                          _c("strong", [_vm._v(_vm._s(_vm.filters.on_date))]),
                          _vm._v(" with "),
                          _c("strong", [
                            _vm._v(_vm._s(_vm.filters.stat.toLowerCase()))
                          ]),
                      ...
                      ? _c("span", { staticClass: "fs-7" }, [
                          _vm._v(
                            "\n                        No payments made between "
                          ),
                          _c("strong", [_vm._v(_vm._s(_vm.filters.from_dt1))]),
                          _vm._v(" and "),
                          _c("strong", [_vm._v(_vm._s(_vm.filters.from_dt2))]),
                          _vm._v(" with "),
                          _c("strong", [
                            _vm._v(_vm._s(_vm.filters.stat.toLowerCase()))
                          ]),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655& ***!
  \***************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/js/components/account/Bill.vue":
/*!**************************************************!*\
  !*** ./resources/js/components/account/Bill.vue ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Bill.vue?vue&type=template&id=39e95614& */ "./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614&");
/* harmony import */ var _Bill_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Bill.vue?vue&type=script&lang=js& */ "./resources/js/components/account/Bill.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/Bill.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/Bill.vue?vue&type=script&lang=js&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/account/Bill.vue?vue&type=script&lang=js& ***!
  \***************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614& ***!
  \*********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Bill.vue?vue&type=template&id=39e95614& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Bill.vue?vue&type=template&id=39e95614&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Bill_vue_vue_type_template_id_39e95614___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/account/Dashboard.vue":
/*!*******************************************************!*\
  !*** ./resources/js/components/account/Dashboard.vue ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Dashboard.vue?vue&type=template&id=d88c2d52& */ "./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_1__["default"])(
  script,
  _Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/Dashboard.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52& ***!
  \**************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Dashboard.vue?vue&type=template&id=d88c2d52& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Dashboard.vue?vue&type=template&id=d88c2d52&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_d88c2d52___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/account/Patient.vue":
/*!*****************************************************!*\
  !*** ./resources/js/components/account/Patient.vue ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Patient.vue?vue&type=template&id=74f8d808& */ "./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808&");
/* harmony import */ var _Patient_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Patient.vue?vue&type=script&lang=js& */ "./resources/js/components/account/Patient.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/Patient.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/Patient.vue?vue&type=script&lang=js&":
/*!******************************************************************************!*\
  !*** ./resources/js/components/account/Patient.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808&":
/*!************************************************************************************!*\
  !*** ./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808& ***!
  \************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Patient.vue?vue&type=template&id=74f8d808& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patient.vue?vue&type=template&id=74f8d808&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patient_vue_vue_type_template_id_74f8d808___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/account/Patients.vue":
/*!******************************************************!*\
  !*** ./resources/js/components/account/Patients.vue ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Patients.vue?vue&type=template&id=2dcdca1b& */ "./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b&");
/* harmony import */ var _Patients_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Patients.vue?vue&type=script&lang=js& */ "./resources/js/components/account/Patients.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/Patients.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/Patients.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/components/account/Patients.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b& ***!
  \*************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Patients.vue?vue&type=template&id=2dcdca1b& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Patients.vue?vue&type=template&id=2dcdca1b&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Patients_vue_vue_type_template_id_2dcdca1b___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/account/PaymentSummary.vue":
/*!************************************************************!*\
  !*** ./resources/js/components/account/PaymentSummary.vue ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PaymentSummary.vue?vue&type=template&id=db38cbe6& */ "./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6&");
/* harmony import */ var _PaymentSummary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PaymentSummary.vue?vue&type=script&lang=js& */ "./resources/js/components/account/PaymentSummary.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__["render"],
  _PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/PaymentSummary.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/PaymentSummary.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/account/PaymentSummary.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6& ***!
  \*******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./PaymentSummary.vue?vue&type=template&id=db38cbe6& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/PaymentSummary.vue?vue&type=template&id=db38cbe6&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PaymentSummary_vue_vue_type_template_id_db38cbe6___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/account/Payments.vue":
/*!******************************************************!*\
  !*** ./resources/js/components/account/Payments.vue ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Payments.vue?vue&type=template&id=444ebbba& */ "./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba&");
/* harmony import */ var _Payments_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Payments.vue?vue&type=script&lang=js& */ "./resources/js/components/account/Payments.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/account/Payments.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/account/Payments.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/components/account/Payments.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba& ***!
  \*************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Payments.vue?vue&type=template&id=444ebbba& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/account/Payments.vue?vue&type=template&id=444ebbba&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Payments_vue_vue_type_template_id_444ebbba___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/admin/Parent.vue":
/*!**************************************************!*\
  !*** ./resources/js/components/admin/Parent.vue ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Parent.vue?vue&type=template&id=3abca655& */ "./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_1__["default"])(
  script,
  _Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/admin/Parent.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655& ***!
  \*********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Parent.vue?vue&type=template&id=3abca655& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/Parent.vue?vue&type=template&id=3abca655&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Parent_vue_vue_type_template_id_3abca655___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/module/account/accsite.js":
/*!************************************************!*\
  !*** ./resources/js/module/account/accsite.js ***!
  \************************************************/
/*! no exports provided */
...
/* harmony import */ var _admin_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../admin/store */ "./resources/js/module/admin/store.js");
/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./route */ "./resources/js/module/account/route.js");
...
axios.interceptors.request.use(function (config) {
  if (_admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].getters.isAuth) {
    var token = _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].getters.getToken();
...
new Vue({
  el: '#hplaccapp',
  store: _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"],
  router: _route__WEBPACK_IMPORTED_MODULE_2__["router"],
  data: {
    pgload: true,
    clear: false,
    status: {
  ...
  mounted: function mounted() {
    ...
    this.checkAuth().then(function () {
      var user = _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].getters.getCookie('acclient');

      if (!!user) {
        axios.post('api/personnels', {
          uinfo: user
        }).then(function (response) {
          _this.personnels = response.data; // this.$refs.online_users.startEcho(this.personnels, user)
        })["catch"](function (error) {
          console.log(error);
        });
      }
  ...
  methods: {
    checkAuth: function checkAuth() {
      ...
      return new Promise(function (res, rej) {
        if (_admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].getters.isAuth()) {
          _this2.clear = true;
          _this2.elmblock = false;
          _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].commit('setAuthCheck', true);
          var rpath = window.location.pathname;
          _route__WEBPACK_IMPORTED_MODULE_2__["router"].replace({
            path: rpath.indexOf('hpl') !== -1 ? rpath : '/hpl/dashboard'
          });
          _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].dispatch('verifyUser').then(function () {
            res();
          })["catch"](function (err) {
            // this.pgload = false;
            _this2.clear = false;
          ...
          _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].dispatch('setAccessToken').then(function () {
            _this2.clear = true;
            _this2.pgload = false;
            _this2.elmblock = false;
            _admin_store__WEBPACK_IMPORTED_MODULE_1__["store"].commit('setAuthCheck', true);
            ...
            _this2.clear = false;
            _this2.pgload = false;
            _this2.elmblock = true;
            rej();
          });
        }
      });
    },
    fireNotifier: function fireNotifier(message, status) {
      alertify.set('notifier', 'position', 'top-center');
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapGetters"])({
    ...
    luxonDate: function luxonDate() {
      return luxon__WEBPACK_IMPORTED_MODULE_6__["DateTime"];
    }
  })
});
...
/***/ "./resources/js/module/account/route.js":
/*!**********************************************!*\
  !*** ./resources/js/module/account/route.js ***!
  \**********************************************/
...
/* harmony import */ var _components_admin_Parent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/admin/Parent */ "./resources/js/components/admin/Parent.vue");
/* harmony import */ var _components_account_Dashboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/account/Dashboard */ "./resources/js/components/account/Dashboard.vue");
/* harmony import */ var _components_account_Patients__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/account/Patients */ "./resources/js/components/account/Patients.vue");
/* harmony import */ var _components_account_Patient__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/account/Patient */ "./resources/js/components/account/Patient.vue");
/* harmony import */ var _components_account_PaymentSummary__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/account/PaymentSummary */ "./resources/js/components/account/PaymentSummary.vue");
/* harmony import */ var _components_account_Payments__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../components/account/Payments */ "./resources/js/components/account/Payments.vue");
/* harmony import */ var _components_account_Bill__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/account/Bill */ "./resources/js/components/account/Bill.vue");
/* harmony import */ var _admin_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../admin/store */ "./resources/js/module/admin/store.js");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_0__["default"]({
  routes: [{
    path: '/hpl',
    component: _components_admin_Parent__WEBPACK_IMPORTED_MODULE_1__["default"],
    children: [{
      path: 'dashboard',
      component: _components_account_Dashboard__WEBPACK_IMPORTED_MODULE_2__["default"]
    }, {
      path: 'patients',
      component: _components_account_Patients__WEBPACK_IMPORTED_MODULE_3__["default"]
    }, {
      path: 'patient/:pat',
      name: 'patient',
      component: _components_account_Patient__WEBPACK_IMPORTED_MODULE_4__["default"],
      props: true
    }, {
      path: 'payment-summary',
      component: _components_account_PaymentSummary__WEBPACK_IMPORTED_MODULE_5__["default"]
    }, {
      path: 'payments',
      component: _components_account_Payments__WEBPACK_IMPORTED_MODULE_6__["default"]
    }, {
      path: 'bill/:pay',
      name: 'bill',
      component: _components_account_Bill__WEBPACK_IMPORTED_MODULE_7__["default"],
      props: true
    }]
  }],
  mode: 'history'
...
router.beforeEach(function (to, from, next) {
  if (_admin_store__WEBPACK_IMPORTED_MODULE_8__["store"].getters.isAuthCheck) {
    if (_admin_store__WEBPACK_IMPORTED_MODULE_8__["store"].getters.IsInactive) {
      _admin_store__WEBPACK_IMPORTED_MODULE_8__["store"].dispatch('forceLogout');
      next(false);
    }

    if (_admin_store__WEBPACK_IMPORTED_MODULE_8__["store"].getters.isAuth()) {
      _admin_store__WEBPACK_IMPORTED_MODULE_8__["store"].commit('setTimestamp');
      next();
    } else {
      next(false);
    }
...
/***/ "./resources/js/module/admin/store.js":
/*!********************************************!*\
  !*** ./resources/js/module/admin/store.js ***!
  \********************************************/
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_0__["default"].Store({
  ...
  getters: {
    // inSession: (state) => () => {
    // },
    isAuth: function isAuth(state, getters) {
      return function () {
    ...
    getToken: function getToken(state, getters) {
      return function () {
        var token = getters.getCookie('hplactk');

        if (token) {
          var expire = getters.getCookie('tkexp');

          if (expire) {
            if (Date.now() < parseInt(expire)) return token;else {
    ...
    getTimestamp: function getTimestamp(state) {
      return state.timestamp;
    },
    IsInactive: function IsInactive(state) {
      if (state.timestamp == 0) return false;
      if (Date.now() - state.timestamp > state.period * 1000) return true;else return false;
    },
    isAuthCheck: function isAuthCheck(state) {
  ...
  mutations: {
    setUsername: function setUsername(state, user) {
      state.username = user;
    },
    setTimestamp: function setTimestamp(state) {
      state.timestamp = Date.now();
    },
    setAuthCheck: function setAuthCheck(state, stat) {
      state.authcheck = !!stat;
    },
    setCookie: function setCookie(state, data) {
      var d = new Date();
    ...
    destroyToken: function destroyToken(state) {
      ...
      document.cookie = 'acclient=; Max-Age=-99999999;domain=' + window.location.hostname + ";path=/"; // state.token = '';
    }
  },
  actions: {
    setToken: function setToken(_ref, payload) {
      ...
      commit('setCookie', {
        name: 'tkexp',
        value: Date.now() + parseInt(payload.expire) * 1000,
        ts: 43200
      });
      commit('setCookie', {
        name: 'acclient',
    ...
    setAccessToken: function setAccessToken(_ref2) {
      var commit = _ref2.commit,
          dispatch = _ref2.dispatch;
      commit('destroyToken');
      return new Promise(function (res, rej) {
        axios.post('/access').then(function (response) {
    ...
    verifyUser: function verifyUser(_ref3) {
      var commit = _ref3.commit,
          getters = _ref3.getters,
          dispatch = _ref3.dispatch;
      return new Promise(function (resolve, reject) {
        var clientele = getters.getCookie('acclient'); // const token = document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        if (!!clientele) {
          ...
          dispatch('setAccessToken').then(function (success) {
            resolve(200);
          })["catch"](function (error) {
            reject(error);
          });
    ...
    softLogout: function softLogout(_ref4) {
      var dispatch = _ref4.dispatch;
      var elm = document.getElementById('logout-form');
    ...
    forceLogout: function forceLogout(_ref5) {
...
/***/ 5:
/*!******************************************************!*\
  !*** multi ./resources/js/module/account/accsite.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\prj\lara\hospital\resources\js\module\account\accsite.js */"./resources/js/module/account/accsite.js");
