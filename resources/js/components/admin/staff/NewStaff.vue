<template>
    <div>
        <page-heading heading="New Staff"></page-heading>
        <div>
                        ...
                        <div class="card-body p-3">
                            <form action="javascript:void(0)" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" :class="{'form-control':true, 'is-invalid':$v.form.phone.$error || getError('job_title')}" v-model="form.job_title" placeholder="Job Title">
                                    <div class="invalid-feedback">
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            if(!this.$v.form.$invalid) {
                ...
                axios.post('api/staff/new/', fmdata, {headers: { 'Content-Type': 'multipart/form-data' }})
                .then(response => {
                    this.loading = false
    ...
    validations: {
        form: {
            ...
            phone: {required},
            job_title: {maxLength: maxLength(80)}
        }
