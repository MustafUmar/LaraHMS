<template>
    <div>
        <page-heading heading="New Doctor"></page-heading>
        <div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <form action="javascript:void(0)" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <p class="text-center"><em>A default password will be set and sent to this doctor to activate account.</em></p>
                                    </div>
                                </div>
                                <hr class="hr">
                                <div class="form-group">
    ...
    methods: {
        ...
        submitForm() {
            ...
            if(!this.$v.form.$invalid) {
                ...
                axios.post('api/doc/new/', fmdata, {headers: { 'Content-Type': 'multipart/form-data' }})
                .then(response => {
                    this.loading = false
