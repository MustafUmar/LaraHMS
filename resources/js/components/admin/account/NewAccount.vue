<template>
    <div>
        <page-heading heading="New Accountant"></page-heading>
                ...
                <div class="col-md-10 col-sm-11">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-new-account-tab" data-toggle="tab" href="#nav-new-account" role="tab" aria-controls="nav-new-account" aria-selected="true">Create new accountant</a>
                            <a class="nav-item nav-link" id="nav-search-tab" data-toggle="tab" href="#nav-search" role="tab" aria-controls="nav-search" aria-selected="false">Search staff</a>
                        </div>
                    </nav>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <!-- new account -->
                                <div class="tab-pane fade show active" id="nav-new-account" role="tabpanel" aria-labelledby="nav-new-account-tab">
                                ...
                                <div class="tab-pane fade" id="nav-search" role="tabpanel" aria-labelledby="nav-search-tab">
                                    ...
                                    <div class="row thin-light-border bg-lightgray p-2">
                                        <div class="col-md-2">
                                            <div class="img-size-4">
                                                <img src="/images/abstrct_doc.png" class="img-thumbnail img-fluid" alt="...">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h5>John Doe</h5>
                                        ...
                                        <div class="col-md-4">
                                            <button class="btn btn-success">Set as receptionist</button>
                                        </div>
                                    </div>
    ...
    methods: {
        submitForm() {
            ...
            if(!this.$v.form.$invalid) {
                ...
                axios.post('api/account/new/', fmdata, {headers: { 'Content-Type': 'multipart/form-data' }})
                .then(response => {
                    console.log(response.data)
                    this.loading = false
                    this.$router.replace('/hpl/accounts', () => {
                        this.$root.fireNotifier('Accountant created successfully', 'success')
                    })
                }).catch(error => {
                    this.loading = false
                    if(error.response) {
